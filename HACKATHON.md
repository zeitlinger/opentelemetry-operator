...
**Resolved gaps:**
- `k8s.deployment.name` — derived from ReplicaSet name using hash-strip heuristic (same as deriveServiceName)
- `k8s.cronjob.name` — derived from Job name using hash-strip heuristic
